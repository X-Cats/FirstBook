...
public class ViewMembersActivity extends Activity{
    ...
    public void showSubteamInfo() {
        ...
        if (!c.moveToFirst()) {
            ...
            c.moveToNext();
//            name4.setText(c.getString(c.getColumnIndex(DirectoryProvider.NAME)));
//            c.moveToNext();
//            name5.setText(c.getString(c.getColumnIndex(DirectoryProvider.NAME)));
//            c.moveToNext();
//            name6.setText(c.getString(c.getColumnIndex(DirectoryProvider.NAME)));
//            c.moveToNext();
        }
